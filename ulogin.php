...
<body>
  ...
  <a class="navbar-brand"  href="index.html">The Restaurant Expert</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav mr-auto">
      ...
      <div class="dropdown-menu">
       ...
       <a class="dropdown-item" href="rsignup.php" >Admin Sign Up</a>
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
       ...
       <a class="dropdown-item" href="rlogin.php" >Admin Login</a>
 ...
 <br>
    <button type="submit" name="sub" style="background-color:red;" class="btn btn-primary">Submit</button>
</form>
